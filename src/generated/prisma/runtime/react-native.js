...
function hl(e) {
    let t = {
        ...
        r = (...n) => {
            ...
            if ((n.length !== 0 && Ot.push([o, ...n]), Ot.length > ml && Ot.shift(), Mt.enabled(o) || i)) {
...
var j = (function () {
    ...
    return function (n, i, o, s, a, l) {
        ...
        if (!X || !X[0] || !$ || !$[0])
            return new er(
                !n.s || !i.s || (X ? $ && X[0] == $[0] : !$) ? NaN : (X && X[0] == 0) || !$ ? Yr * 0 : Yr / 0,
            );
        for (
...
var Xt = class {
    ...
    async start() {
        if ((await this.libraryInstantiationPromise, await this.libraryStoppingPromise, this.libraryStartingPromise))
            return (
                Te(`library already starting, this.libraryStarted: ${this.libraryStarted}`), this.libraryStartingPromise
            );
...
${a.backtrace}`,
    ...
    async requestBatch(t, { transaction: r, traceparent: n }) {
        ...
        (this.lastQuery = JSON.stringify(i)),
            (this.executingQueryPromise = this.engine.query(this.lastQuery, JSON.stringify({ traceparent: n }), qs(r)));
...
var Zn =
        ...
        (r) => {
            ...
            return (
                i?.values ? Ws(`prisma.${e}(${n}, ${i.values})`) : Ws(`prisma.${e}(${n})`), { query: n, parameters: i }
            );
        },
    Ks = {
        ...
        _request(n) {
            ...
            let i = n.middlewareArgsMapper ?? Yp,
                ...
                l = async (u) => {
                    ...
                    if (g)
                        return this._tracingHelper.runInChildSpan(s.middleware, (M) => g(u, (I) => (M?.end(), l(I))));
